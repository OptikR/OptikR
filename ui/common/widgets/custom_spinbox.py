...
class CustomSpinBox(QWidget):
    ...
    def _init_ui(self):
        ...
        self.minus_btn.setStyleSheet(_BUTTON_STYLE)
        ...
        self.value_input.setMinimumWidth(50)
        self.value_input.setMaximumWidth(110)
        ...
        self.plus_btn.setStyleSheet(_BUTTON_STYLE)
...
class CustomDoubleSpinBox(QWidget):
    ...
    def _increment(self):
        """Increment value."""
        if self._value < self._maximum:
            self.setValue(round(self._value + self._single_step, self._decimals))
