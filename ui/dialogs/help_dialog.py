...
class HelpDialog(QDialog):
    ...
    def __init__(self, config_manager=None, parent=None):
        ...
        self.setWindowTitle(tr("realtime_translation_system_help"))
    ...
    def init_ui(self):
        ...
        # Add all tabs
        tab_widget.addTab(self._create_getting_started_tab(), tr("getting_started"))
        tab_widget.addTab(self._create_settings_guide_tab(), tr("settings_guide"))
        tab_widget.addTab(self._create_troubleshooting_tab(), tr("troubleshooting"))
        tab_widget.addTab(self._create_shortcuts_tab(), tr("shortcuts"))
        tab_widget.addTab(self._create_about_tab(), tr("about"))
    ...
    def _create_shortcuts_tab(self):
        ...
        <table border="1" cellpadding="5" cellspacing="0" style="border-collapse: collapse;">
            ...
            <tr>
                <td><b>Configurable (default: Ctrl + T)</b></td>
                <td>Pipeline hotkey (text/audio: start-stop, vision: one-shot frame)</td>
            </tr>
            <tr>
                <td><b>Ctrl + R</b></td>
